  ...
  useEffect(() => {
    ...
    async function fetchProduct() {
      ...
      try {
        ...
        // Title and meta description are set server-side by `generateMetadata` in
        // page.tsx. Overwriting them here would clobber the server-rendered values.
      ...
      <main className="flex-grow pb-16 pt-[92px]">
        ...
        <TemplateSections
          ...
          slots={{
            ...
            juulCollectionFeature1: () => null,
            juulCollectionFeature2: () => null,
